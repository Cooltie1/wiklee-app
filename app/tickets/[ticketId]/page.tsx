      ...
      <div className="flex h-full min-h-0 flex-col bg-white">
        <div className="border-b border-zinc-100 px-6 pb-3 pt-4">
          ...
          <Input
            ...
            className={`mt-2 h-auto w-full min-w-0 overflow-hidden text-ellipsis whitespace-nowrap rounded-md border px-2 py-1 text-[2rem] font-semibold leading-tight shadow-none transition-colors focus-visible:ring-0 ${
              isTitleBlank
